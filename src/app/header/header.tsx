        ...
        <header className="bg-[#f3f4f6] sticky top-0 z-50 px-5 md:px-0">
            <nav aria-label="Global" className="mx-auto flex max-w-7xl items-center justify-between p-2 lg:px-8">
                ...
                <PopoverGroup className="hidden lg:flex lg:gap-x-12">
                    ...
                    <a href="/question" className="text-sm/6 font-semibold text-gray-900">
                        Question
                    </a>
                    <a href="/tips" className="text-sm/6 font-semibold text-gray-900">
                        Tips
                    </a>
                    <a href="/carrier" className="text-sm/6 font-semibold text-gray-900">
                        Carrier Advice
                    </a>
                </PopoverGroup>
